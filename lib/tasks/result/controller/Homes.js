  ...
  views: [
    ...
    'master.home.Form',
  	...
  	refs: [
		...
		{
			ref : 'searchField',
			selector: 'homelist textfield[name=searchField]'
		}
	],
    ...
    this.control({
      ...
      'homelist button[action=deleteObject]': {
        ...
        change: this.liveSearch
			...
			'homelist button[action=markasdeceasedObject]': {
        click: this.markAsDeceasedObject
			...
			'homelist button[action=unmarkasdeceasedObject]': {
        click: this.unmarkAsDeceasedObject
			...
			'homelist button[action=markasrunawayObject]': {
