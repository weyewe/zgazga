...
describe PurchaseDownPayment do
  before(:each) do
  ...
  context "create PurchaseDownPayment" do
    before(:each) do
    ...
    it "should create PurchaseDownPayment" do
      @sdp.errors.size.should == 0
      @sdp.should be_valid
    end
    
    context "confirm PurchaseDownPayment" do
      before(:each) do
        @sdp.confirm_object(:confirmed_at => DateTime.now)
      end
      
      it "should confirm PurchaseDownPayment" do
        @sdp.errors.size.should == 0
      ...
      context "unconfirm PurchaseDownPayment" do
        before(:each) do
          @sdp.unconfirm_object
        end
        
        it "should unconfirm PurchaseDownPayment" do
          @sdp.errors.size.should == 0
