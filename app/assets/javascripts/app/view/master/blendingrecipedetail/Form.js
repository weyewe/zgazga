...
Ext.define('AM.view.master.blendingrecipedetail.Form', {
...
// if autoShow == true.. on instantiation, will automatically be called 
  ...
  initComponent: function() {
	...
	setParentData: function( record) {
		this.down('form').getForm().findField('blending_recipe_id').setValue(record.get('id'));
	}
