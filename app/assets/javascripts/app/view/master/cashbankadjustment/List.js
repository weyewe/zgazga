Ext.define('AM.view.master.cashbankadjustment.List' ,{
	...
	initComponent: function() {
      ...
      {	header: 'Tanggal Konfirmasi', dataIndex: 'confirmed_at', flex: 1 } ,
		...
		this.addObjectButton = new Ext.Button({
			text: 'Add CashBankAdjustment',
			action: 'addObject'
		});

		this.editObjectButton = new Ext.Button({
			text: 'Edit CashBankAdjustment',
			action: 'editObject',
			disabled: true
		});
    ...
    this.confirmObjectButton = new Ext.Button({
			text: 'Confirm CashBankAdjustment',
			action: 'confirmObject',
			disabled: true
		});
    
    this.unconfirmObjectButton = new Ext.Button({
			text: 'Unconfirm CashBankAdjustment',
