...
Ext.define('AM.view.operation.recoveryorder.FilterForm', {
  extend: 'Ext.window.Window',
  alias : 'widget.filterrecoveryorderform',

  title : 'Filter RecoveryOrder',
  layout: 'fit',
	width	: 500,
    ...
    this.items = [{
      ...
      items: [
    			...
    			
    			{
    				...
    				queryMode: 'remote',
    				forceSelection: true, 
    				displayField : 'roller_identification_nomor_disasembly',
    				valueField : 'roller_identification_form_id',
    				pageSize : 5,
    				minChars : 1, 
    				allowBlank : false, 
    				triggerAction: 'all',
    				store : remoteJsonStoreRollerIdentificationForm , 
    				listConfig : {
    					getInnerTpl: function(){
    						return  	'<div data-qtip="{roller_identification_nomor_disasembly}">' + 
    										 
    												'<div class="combo-name">No Dis: {roller_identification_nomor_disasembly}</div>' + 
    						 					'</div>';
    					}
    				},
    				name : 'roller_identification_form_id' 
