Ext.define('AM.view.operation.customerstockadjustment.List' ,{
  	extend: 'Ext.grid.Panel',
  	alias : 'widget.customerstockadjustmentlist',

  	store: 'CustomerStockAdjustments',  
		...
		this.columns = [
			...
			{ header: 'Kode',  dataIndex: 'code', flex: 1},
			{
				...
				tpl :  	'Tanggal Penyesuaian: <br /> <b>{adjustment_date}</b>' + '<br />' + '<br />' +
							...
							'Customer:  <br /> <b>{contact_name}</b>'   + '<br />' + '<br />' +
							'{description}'   
			},
