Ext.define('AM.view.operation.paymentrequestdetail.List' ,{
  	extend: 'Ext.grid.Panel',
  	alias : 'widget.paymentrequestdetaillist',

  	store: 'PaymentRequestDetails', 
	...
	setObjectTitle : function(record){
		this.setTitle("PaymentRequest: " + record.get("code"));
	},
