Ext.define('AM.view.operation.customerstockadjustmentdetail.List' ,{
  	extend: 'Ext.grid.Panel',
  	alias : 'widget.customerstockadjustmentdetaillist',

  	store: 'CustomerStockAdjustmentDetails', 
	...
	setObjectTitle : function(record){
		this.setTitle("CustomerStockAdjustment: " + record.get("code"));
	}
});
