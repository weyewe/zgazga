Ext.define('AM.view.operation.salesdowmpaymentallocation.ConfirmForm', {
  extend: 'Ext.window.Window',
  alias : 'widget.confirmsalesdowmpaymentallocationform',

  title : 'Confirm SalesDowmPaymentAllocation',
  layout: 'fit',
	width	: 400,
