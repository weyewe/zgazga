Ext.define('AM.view.operation.warehousemutationdetail.List' ,{
  	extend: 'Ext.grid.Panel',
  	alias : 'widget.warehousemutationdetaillist',

  	store: 'WarehouseMutationDetails', 
	...
	setObjectTitle : function(record){
		this.setTitle("WarehouseMutation: " + record.get("code"));
	}
});
