Ext.define('AM.view.operation.purchasedownpaymentallocationdetail.List' ,{
  	extend: 'Ext.grid.Panel',
  	alias : 'widget.purchasedownpaymentallocationdetaillist',

  	store: 'PurchaseDownPaymentAllocationDetails', 
