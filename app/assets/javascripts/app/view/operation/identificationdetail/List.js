Ext.define('AM.view.operation.identificationdetail.List' ,{
  	extend: 'Ext.grid.Panel',
  	alias : 'widget.identificationdetaillist',

  	store: 'IdentificationDetails', 
	...
	setObjectTitle : function(record){
		this.setTitle("Identification: " + record.get("code"));
	}
});
