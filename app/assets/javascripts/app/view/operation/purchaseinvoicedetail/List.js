Ext.define('AM.view.operation.purchaseinvoicedetail.List' ,{
  	extend: 'Ext.grid.Panel',
  	alias : 'widget.purchaseinvoicedetaillist',

  	store: 'PurchaseInvoiceDetails', 
	...
	setObjectTitle : function(record){
		this.setTitle("PurchaseInvoice: " + record.get("code"));
	}
});
