Ext.define('AM.controller.BankAdministrationDetails', {
  extend: 'Ext.app.Controller',

  stores: ['BankAdministrationDetails', 'BankAdministrations'],
  models: ['BankAdministrationDetail'],

  views: [
    'operation.bankadministrationdetail.List',
    'operation.bankadministrationdetail.Form',
  ...
  init: function() {
    this.control({
      'bankadministrationdetaillist': {
        itemdblclick: this.editObject,
        selectionchange: this.selectionChange ,
				afterrender : this.loadObjectList
      },
      'bankadministrationdetailform button[action=save]': {
        click: this.updateObject
      },

	 
      'bankadministrationdetaillist button[action=addObject]': {
        click: this.addObject
      },

			'bankadministrationdetaillist button[action=repeatObject]': {
        click: this.addObject
      },


      'bankadministrationdetaillist button[action=editObject]': {
	...
	reloadStore : function(record){
		...
		var store = this.getBankAdministrationDetailsStore();
  ...
  addObject: function(button) {
		...
		var widgetName = 'bankadministrationdetailform'; 
  ...
  updateObject: function(button) {
    ...
    var values = form.getValues();
		...
		if( record ){
			...
			record.save({
				params : {
					bank_administration_id : parentRecord.get('id')
				},
			...
			var newObject = new AM.model.BankAdministrationDetail( values ) ;
