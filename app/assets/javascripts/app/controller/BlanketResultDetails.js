Ext.define('AM.controller.BlanketResultDetails', {
  extend: 'Ext.app.Controller',

  stores: ['BlanketResultDetails', 'BlanketResults'],
  models: ['BlanketResultDetail'],

  views: [
    'operation.blanketresultdetail.List',
    'operation.blanketresultdetail.Form',
  ...
  init: function() {
    this.control({
      'blanketresultdetaillist': {
        itemdblclick: this.editObject,
        selectionchange: this.selectionChange ,
				afterrender : this.loadObjectList
      },
      'blanketresultdetailform button[action=save]': {
        click: this.updateObject
      },

	 
      'blanketresultdetaillist button[action=addObject]': {
        click: this.addObject
      },

			'blanketresultdetaillist button[action=repeatObject]': {
        click: this.addObject
      },


      'blanketresultdetaillist button[action=editObject]': {
        click: this.editObject
      },
      'blanketresultdetaillist button[action=deleteObject]': {
        click: this.deleteObject
      },
 			
 			'blanketresultdetaillist textfield[name=searchField]': {
	...
	liveSearch : function(grid, newValue, oldValue, options){
		...
		me.getBlanketResultDetailsStore().getProxy().extraParams.livesearch = newValue; 
	  
		me.getBlanketResultDetailsStore().load();
	},
	...
	reloadStore : function(record){
		...
		var store = this.getBlanketResultDetailsStore();
  ...
  addObject: function(button) {
		...
		var widgetName = 'blanketresultdetailform'; 
  ...
  updateObject: function(button) {
    ...
    var values = form.getValues();
		...
		if( record ){
			...
			record.save({
				params : {
					blanket_result_id : parentRecord.get('id')
				},
			...
			var newObject = new AM.model.BlanketResultDetail( values ) ;
    ...
    var record = this.getList().getSelectedObject();
		if(!record){return;}
		var parent_id = record.get('blanket_result_id');
		var list  = this.getList();
