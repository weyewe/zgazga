Ext.define('AM.controller.PurchaseOrderDetails', {
  extend: 'Ext.app.Controller',

  stores: ['PurchaseOrderDetails', 'PurchaseOrders'],
    ...
    this.control({
      ...
      'purchaseorderdetaillist button[action=addObject]': {
        click: this.addObject
			...
			'purchaseorderdetaillist button[action=repeatObject]': {
        click: this.addObject
      },
  ...
  addObject: function(button) {
		...
		var widgetName = 'purchaseorderdetailform'; 
