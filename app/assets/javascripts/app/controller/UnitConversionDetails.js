Ext.define('AM.controller.UnitConversionDetails', {
  extend: 'Ext.app.Controller',

  stores: ['UnitConversionDetails', 'UnitConversions'],
  models: ['UnitConversionDetail'],

  views: [
    'master.unitconversiondetail.List',
    'master.unitconversiondetail.Form',
  ...
  init: function() {
    this.control({
      'unitconversiondetaillist': {
        itemdblclick: this.editObject,
        selectionchange: this.selectionChange ,
				afterrender : this.loadObjectList
      },
      'unitconversiondetailform button[action=save]': {
        click: this.updateObject
      },

	 
      'unitconversiondetaillist button[action=addObject]': {
        click: this.addObject
      },

			'unitconversiondetaillist button[action=repeatObject]': {
        click: this.addObject
      },


      'unitconversiondetaillist button[action=editObject]': {
        click: this.editObject
      },
      'unitconversiondetaillist button[action=deleteObject]': {
	...
	reloadStore : function(record){
		...
		var store = this.getUnitConversionDetailsStore();
  ...
  addObject: function(button) {
		...
		var widgetName = 'unitconversiondetailform'; 
  ...
  updateObject: function(button) {
    ...
    var values = form.getValues();
		...
		if( record ){
			...
			record.save({
				params : {
					unit_conversion_id : parentRecord.get('id')
				},
			...
			var newObject = new AM.model.UnitConversionDetail( values ) ;
    ...
    var record = this.getList().getSelectedObject();
		if(!record){return;}
		var parent_id = record.get('unit_conversion_id');
		var list  = this.getList();
