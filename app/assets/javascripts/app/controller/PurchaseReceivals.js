Ext.define('AM.controller.PurchaseReceivals', {
  ...
  init: function() {
    this.control({
      ...
      'purchasereceivalProcess purchasereceivalform button[action=save]': {
        click: this.updateObject
      },
			'purchasereceivalProcess purchasereceivalform customcolorpicker' : {
      ...
      'purchasereceivalProcess purchasereceivallist button[action=deleteObject]': {
        ...
        click: this.unconfirmObject
			...
			'unconfirmpurchasereceivalform button[action=confirm]' : {
