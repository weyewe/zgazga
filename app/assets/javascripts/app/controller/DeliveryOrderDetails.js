Ext.define('AM.controller.DeliveryOrderDetails', {
  extend: 'Ext.app.Controller',

  stores: ['DeliveryOrderDetails', 'DeliveryOrders'],
  ...
  init: function() {
    this.control({
      ...
      'deliveryorderdetaillist button[action=addObject]': {
        click: this.addObject
			...
			'deliveryorderdetaillist button[action=repeatObject]': {
        click: this.addObject
      },
      ...
      'deliveryorderdetaillist button[action=deleteObject]': {
        click: this.deleteObject
 			...
 			'deliveryorderdetaillist textfield[name=searchField]': {
	...
	liveSearch : function(grid, newValue, oldValue, options){
		...
		me.getDeliveryOrderDetailsStore().getProxy().extraParams.livesearch = newValue; 
	  
		me.getDeliveryOrderDetailsStore().load();
	},
  ...
  addObject: function(button) {
		...
		var widgetName = 'deliveryorderdetailform'; 
  ...
  updateObject: function(button) {
    ...
    var values = form.getValues();
		...
		if( record ){
			...
			record.save({
				params : {
					delivery_order_id : parentRecord.get('id')
				},
    ...
    var record = this.getList().getSelectedObject();
		if(!record){return;}
		var parent_id = record.get('delivery_order_id');
		var list  = this.getList();
