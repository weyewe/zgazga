Ext.define('AM.controller.TemporaryDeliveryOrders', {
  ...
  selectionChange: function(selectionModel, selections) {
	...
	updateChildGrid: function(record){
		var templateDetailGrid = this.getTemporaryDeliveryOrderDetailList();
		...
		templateDetailGrid.getStore().getProxy().extraParams.temporary_delivery_order_id =  record.get('id') ;
