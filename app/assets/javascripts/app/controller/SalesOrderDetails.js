Ext.define('AM.controller.SalesOrderDetails', {
  extend: 'Ext.app.Controller',

  stores: ['SalesOrderDetails', 'SalesOrders'],
  ...
  init: function() {
    this.control({
      ...
      'salesorderdetaillist button[action=addObject]': {
        click: this.addObject
			...
			'salesorderdetaillist button[action=repeatObject]': {
        click: this.addObject
      },
      ...
      'salesorderdetaillist button[action=deleteObject]': {
        click: this.deleteObject
 			...
 			'salesorderdetaillist textfield[name=searchField]': {
	...
	liveSearch : function(grid, newValue, oldValue, options){
		...
		me.getSalesOrderDetailsStore().getProxy().extraParams.livesearch = newValue; 
	  
		me.getSalesOrderDetailsStore().load();
	},
  ...
  addObject: function(button) {
		...
		var widgetName = 'salesorderdetailform'; 
