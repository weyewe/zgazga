Ext.define('AM.model.ReceiptVoucherDetail', {
      ...
      { name: 'amount_text', type: 'string' }, 
      { name: 'amount_paid', type: 'string' }, 
      { name: 'amount_paid_text', type: 'string' }, 
      { name: 'pph_21', type: 'string' }, 
      { name: 'pph_21_text', type: 'string' }, 
      { name: 'pph_21_rate', type: 'string' }, 
      { name: 'pph_23', type: 'string' }, 
      { name: 'pph_23_text', type: 'string' }, 
