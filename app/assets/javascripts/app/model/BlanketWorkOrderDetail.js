Ext.define('AM.model.BlanketWorkOrderDetail', {
  	...
  	idProperty: 'id' ,
		...
		proxy: {
			url: 'api/blanket_work_order_details',
			type: 'rest',
			format: 'json',

			reader: {
				root: 'blanket_work_order_details',
			...
			writer: {
				getRecordData: function(record) {
					return { blanket_work_order_detail : record.data };
				}
			}
		}
