Ext.define('AM.model.RecoveryResult', {
  	...
  	fields: [
			...
			{ name: 'id', type: 'int' },
	         ...
	         { name: 'recovery_order_roller_identification_form_nomor_disasembly', type: 'string' },
  	...
  	idProperty: 'id' ,
		...
		proxy: {
			url: 'api/recovery_results',
			type: 'rest',
			format: 'json',

			reader: {
				root: 'recovery_results',
			...
			writer: {
				getRecordData: function(record) {
					return { recovery_result : record.data };
				}
			}
		}
