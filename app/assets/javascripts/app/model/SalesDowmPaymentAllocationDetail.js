Ext.define('AM.model.SalesDowmPaymentAllocationDetail', {
  	...
  	idProperty: 'id' ,
		...
		proxy: {
			url: 'api/sales_dowm_payment_allocation_details',
			type: 'rest',
			format: 'json',

			reader: {
				root: 'sales_dowm_payment_allocation_details',
			...
			writer: {
				getRecordData: function(record) {
					return { sales_dowm_payment_allocation_detail : record.data };
				}
			}
		}
