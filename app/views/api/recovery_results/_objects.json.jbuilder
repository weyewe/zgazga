...
json.recovery_results  objects do |object|
    ...
    json.recovery_order_roller_identification_form_nomor_disasembly 	object.recovery_order.roller_identification_form.nomor_disasembly  
